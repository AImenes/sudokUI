...
export const TECHS = {
  ...
  FINNED_JELLYFISH: t(4500, 'Finned Jellyfish', 'Unfair', 'Finned Fish', 250, false),
  SASHIMI_JELLYFISH: t(4600, 'Sashimi Jellyfish', 'Unfair', 'Finned Fish', 260, false),
  ...
  NICE_LOOP: t(5600, 'Nice Loop', 'Unfair', 'Chains and Loops', 280, false),
  GROUPED_NICE_LOOP: t(5650, 'Grouped Nice Loop', 'Unfair', 'Chains and Loops', 300, false),
